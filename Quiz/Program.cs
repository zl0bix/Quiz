...
/* 
 3-e Задание 
Любимая игра StarCraft II
Это RTS в реальном времени, затрудняюсь как эту игру сделать, но я бы разделил программу на части, юниты, карта , действия,
потом сделал основные классы и от них наследовался, впринцепе всЁ)))
 */
}
